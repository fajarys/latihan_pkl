        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('bukus') }}"> <i class="menu-icon fa fa-book"></i>Buku</a>
                    </li>
                    <li>
                        <a href="{{ url('anggotas') }}"> <i class="menu-icon fa fa-drivers-license-o"></i>Anggota</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('vendor/images/admin.jpg') }}">
                        </a>
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa -cog"></i>Settings</a>
                            <a class="nav-link" href="{{ url('register')}}"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
